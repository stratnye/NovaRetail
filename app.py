...
with tab_risk:
    ...
    st.markdown('<p class="section-label">Categories with the Lowest CSAT</p>', unsafe_allow_html=True)
    st.caption("Low CSAT is defined as a CSAT score of 2 or below.")
    csat_threshold = 2
